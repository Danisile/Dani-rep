...
namespace CarParkingApp.Controllers
{
    public class ParkingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Parking_Num,Parking_Type,Slots,Park_Space")] Parking parking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Parking_Num,Parking_Type,Slots,Park_Space")] Parking parking)
        {
            if (ModelState.IsValid)
            {
